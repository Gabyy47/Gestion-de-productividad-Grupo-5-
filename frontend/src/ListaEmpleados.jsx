...
import 'bootstrap/dist/css/bootstrap.min.css'; // Importa Bootstrap para estilos básicos

const BASE_URL = "http://localhost:49146/api/"; // Asegúrate de que esta sea tu URL base
